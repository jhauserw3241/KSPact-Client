...
class MemberGradesTagInput extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        if(this.props.member_id) {
            // Get tags
            fire.database().ref("members").child(this.props.member_id).child("grade_levels").on("value", function(data) {
    ...
    handleDelete(i) {
        ...
        fire.database().ref("members").child(this.props.member_id).child("grade_levels")
        .set(updatedTags);
    }
...
export default MemberGradesTagInput;