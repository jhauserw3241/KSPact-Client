		...
		return (
			<div className="About">
				<div className="container">
					...
					tool supporting other disciplines, i.e. music, literature, mathematics, science, and social studies.
					<br />
					...
					K-12 classrooms to help with computing activities and work with students.
					<br />
