...
class SoftwareGradesTagInput extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        if(this.props.software_id) {
            // Get tags
            fire.database().ref("software").child(this.props.software_id).child("grade_levels").on("value", function(data) {
    ...
    handleDelete(i) {
        ...
        fire.database().ref("software").child(this.props.software_id).child("grade_levels")
        .set(updatedTags);
    }
...
export default SoftwareGradesTagInput;